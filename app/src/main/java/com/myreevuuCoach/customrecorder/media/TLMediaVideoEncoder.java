package com.myreevuuCoach.customrecorder.media;
...
import com.myreevuuCoach.customrecorder.glutils.RenderHandler;
...
public class TLMediaVideoEncoder extends TLMediaEncoder {
    ...
    private static final int DEFAULT_VIDEO_WIDTH = 700;//640;
    private static final int DEFAULT_VIDEO_HEIGHT = 500;//480;
    ...
    public void setFormat(final int width, final int height,
        ...
        if (DEBUG)
            Log.v(TAG, String.format("requested setFormat:size(%d,%d),fps=%d,bps=%d,iframe=%d",
