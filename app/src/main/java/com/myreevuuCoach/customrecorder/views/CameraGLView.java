...
import com.myreevuuCoach.customrecorder.glutils.GLDrawer2D;
...
public final class CameraGLView extends GLSurfaceView {
    ...
    String CAMERA_FLASH_MODE = Camera.Parameters.FLASH_MODE_AUTO;
    ...
    public void setCAMERA_FLASH_MODE(String FLASH_MODE) {
        this.CAMERA_FLASH_MODE = FLASH_MODE;
    }
        ...
        private final void startPreview(int width, int height) {
            ...
            if (mCamera == null) {
                ...
                try {
                    ...
                    if (CAMERA_FLASH_MODE.equalsIgnoreCase(Camera.Parameters.FLASH_MODE_ON)) {
                        params.setFlashMode(Camera.Parameters.FLASH_MODE_ON);
                    } else if (CAMERA_FLASH_MODE.equalsIgnoreCase(Camera.Parameters.FLASH_MODE_OFF)) {
                   ...
                   /* final List<String> focusModes = params.getSupportedFocusModes();
                    ...
                    try {
                        ...
                        if (DEBUG)
                            Log.i(TAG, "Camera does not support FOCUS_MODE_CONTINUOUS_VIDEO");
                    }
                    ...
                    try {
                        ...
                        if (DEBUG)
                            Log.i(TAG, "Camera does not support setVideoStabilization");
                    }
