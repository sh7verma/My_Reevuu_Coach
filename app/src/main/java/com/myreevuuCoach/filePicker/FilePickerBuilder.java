...
import filePicker.DocPickerActivity;
...
//  }
  ...
  public void pickFile(Activity context) {
    mPickerOptionsBundle.putInt(Constants.Companion.getEXTRA_PICKER_TYPE(), Constants.Companion.getDOC_PICKER());
    start(context, Constants.Companion.getREQUEST_CODE_DOC());
  }
...
//  }
  ...
  private void start(Activity context, int requestCode) {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
      if (ContextCompat.checkSelfPermission(context, Constants.Companion.getPERMISSIONS_FILE_PICKER())
