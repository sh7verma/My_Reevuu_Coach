...
class OptionCoachingLevelAdapter(var moptionsArray: ArrayList<DefaultArrayModel.ResponseBean.CoachingLevelsBean>,
                                 var selectedOption: String, var fragment: BaseKotlinFragment,
                                 var enableMultipleOptions: Boolean)
    : RecyclerView.Adapter<OptionCoachingLevelAdapter.ViewHolder>() {

    private val selectOption: SelectOption = fragment
    private var mSelectedMultipleOptions = ArrayList<String>()

    constructor(moptionsArray: ArrayList<DefaultArrayModel.ResponseBean.CoachingLevelsBean>, selectedOption: String,
