...
public class ReviewedVideoActivity extends BaseActivity {
    ...
    protected void onCreateStuff() {
        ...
        if (getIntent().hasExtra(InterConst.REVIEW_REQUEST_ID)) {
            url = RetrofitClient.URL_PREVIEW_VIDEO + getIntent().getStringExtra(InterConst.REVIEW_REQUEST_ID) + "/" + mUtils.getString(InterConst.ACCESS_TOKEN, "");
            Log.d("URL", url);
