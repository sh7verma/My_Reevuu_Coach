...
class ConversationActivityBck : BaseActivity(), FirebaseListeners.ChatDialogsListenerInterfaceForChat,
...
//                .setProfileListener(mUtils!!.getInt(FirebaseChatConstants.user_id, -1).toString())
    ...
    internal fun createNewChat() {
        ...
        mParticpantIDSList.add(mOtherUserId + "_" + FirebaseChatConstants.TYPE_ATHLETE)
        mParticpantIDSList.add(myUserId + "_"
                + FirebaseChatConstants.TYPE_COACH)
        ...
        userType.put(mOtherUserId, FirebaseChatConstants.TYPE_ATHLETE.toString())
