...
public class DialogVideoOption implements View.OnClickListener {
    ...
    public DialogVideoOption(Activity context, DialogRecordVideoCallBack dialogRecordVideoCallBack) {
        mContext = context;
    ...
    public void showDialog() {
        ...
        if (mDialog == null) {
            ...
            view = View.inflate(mContext, R.layout.dialog_video_option, null);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.llCamera:
                dialogRecordVideoCallBack.openVideoOption();
                break;
            case R.id.llBrowse:
                dialogRecordVideoCallBack.openBrowse();
                break;
        }
