...
public class CameraSwitchView extends AppCompatImageButton {
    ...
    private
    @CameraType
    static int currentCameraType = CAMERA_TYPE_REAR;

    private   int padding = 5;

    public static int getCurrentCameraType() {
        return currentCameraType;
    }

    public static  void setCurrentCameraType(int currentCamera) {
         currentCameraType = currentCamera;
    }
    ...
    private class CameraTypeClickListener implements OnClickListener {
        ...
        public void onClick(View view) {
            ...
            setCurrentCameraType(currentCameraType);
