...
public class SandriosCamera {
    ...
    public static InterfacesDone interfacesDone;

    public static InterfacesDone getInterfacesDone() {
        return interfacesDone;
    }

    public ArrayList<ImageGalleryAdapter.PickerTile> getPickerTiles() {
        return pickerTiles;
    }

    public static void setInterfacesDoneListener(InterfacesDone interfac) {
        interfacesDone = interfac;
    }
