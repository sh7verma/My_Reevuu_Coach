...
import com.sandrios.sandriosCamera.internal.ui.viewpager.*;
import com.sandrios.sandriosCamera.internal.ui.viewpager.Utils;
...
public final class CameraHelper {
    ...
    public static File getOutputMediaFile(Context context, @CameraConfiguration.MediaAction int mediaAction) {
       // File mediaStorageDir = context.getFilesDir();
        ...
        File mediaStorageDir = new File(Utils.path);
...
//        System.out.println("Directory Path is;; " +mediaStorageDir);
        return mediaFile;
    }
